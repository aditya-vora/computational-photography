...
4) Thus after getting the homography matrix we shall apply the transform on any one images and just paste the other image beside the 
   transformed image to get the stiched image.
5) In this way we shall use the current stiched image and perform the same procedure for the remaining images to get the final panorama.
